...
var main = new Vue ({
  ...
  data: {
    title: 'Les Stratégies Obliques',
    introduction: 'Génére une stratégie oblique!',
    introductionStyle: {
      fontSize: '0.8em'
    },
    quotes: [
      ...
      'Mécanise quelque chose d’idiosyncratique',
      'Mets de l’ordre',
      ...
      'Résiste résolument au changement',
      ...
      'Un seul élément de chaque sorte',
